...
# Function that ensures the schema is present on the remote server..
function ensure_schema() {
    ...
    # Check if the schema is already present..
...
# 1. Creation of organizational unit for people..
dn: ou=People,dc=nutius,dc=com
objectClass: organizationalUnit
ou: People

# 2. Creation of organizational unit for groups..
dn: ou=Groups,dc=nutius,dc=com
objectClass: organizationalUnit
ou: Groups

# 3. Creation of group 'users' (GID 5000) inside ou=Groups..
